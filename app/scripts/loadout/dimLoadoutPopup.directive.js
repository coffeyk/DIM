  ...
  function LoadoutPopup() {
    return {
      ...
      template: [
        ...
        '      <span ng-click="vm.newLoadout($event)"><i class="fa fa-plus-circle"></i> <span translate="Loadouts.Create"></span></span>',
        '      <span ng-click="vm.newLoadoutFromEquipped($event)" translate="Loadouts.FromEquipped"></span>',
        '    </li>',
        ...
        '      <span translate-attr="{ title: \'Loadouts.Delete\' }" ng-click="vm.deleteLoadout(loadout, $event)"><i class="fa fa-trash-o"></i></span>',
        ...
        '      <span ng-click="vm.gatherEngramsLoadout($event, { exotics: false })"><i class="fa fa-ban"></i> <span translate="Loadouts.GatherEngramsExceptExotics"></span></span>',
        '    </li>',
        '    <li class="loadout-set" ng-if="!vm.store.isVault">',
        '      <span ng-click="vm.startFarming($event)"><img class="fa" src="/images/engram.svg" height="12" width="12"/> <span translate="FarmingMode"></span></span>',
        '    </li>',
        ...
        '      <span ng-click="vm.applyLoadout(vm.previousLoadout, $event)"><span translate="Loadouts.RestoreAllItems"></span></span>',
        '    </li>',
        '  </ul>',
        '</div>'
      ].join('')
